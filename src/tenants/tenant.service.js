...
const CONFIG_KEYS = {
  ...
  SUPPORT_REVIEW_CHANNEL_ID: 'SUPPORT_REVIEW_CHANNEL_ID',
...
async function seedTenantConfig(tenantId) {
  const defaults = {
    ...
    [CONFIG_KEYS.SUPPORT_REVIEW_CHANNEL_ID]: env.SUPPORT_REVIEW_CHANNEL_ID || null,
...
async function syncAllGuilds(client) {
  for (const guild of client.guilds.cache.values()) {
    ...
    if (!config[CONFIG_KEYS.SUPPORT_REVIEW_CHANNEL_ID]) missing.push(CONFIG_KEYS.SUPPORT_REVIEW_CHANNEL_ID);
